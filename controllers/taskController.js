...
const markTaskCompleted = (req,res)=>{
    ...
    taskModel.updateOne({_id:id},{completed:completed}).then(()=>res.status(200).json({message:"Task added to Completed Successfully"})).catch((err)=>res.status(501).json({message:err.message}))
...
export { addTask, getTask,removeTask,markTaskCompleted }
